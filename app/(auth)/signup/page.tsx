        ...
        <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 text-zinc-100">
            ...
            <div className="relative w-full max-w-sm">
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-500 text-sm">Start your journey with us</p>
                </div>
                ...
                {success && (
                    <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 p-3 rounded-lg mb-6 text-sm">
                        {success}
                    </div>
                )}
